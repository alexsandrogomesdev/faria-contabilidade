...
export default function Home() {
  ...
  const differentials = useRef<HTMLDivElement>(null);
  const solutions = useRef<HTMLDivElement>(null);
  const institutional = useRef<HTMLDivElement>(null);
  const contact = useRef<HTMLDivElement>(null);

  const scrollTo = (target: string) => {
    console.log(target);
    if (target === "Diferenciais") {
      differentials.current?.scrollIntoView({ behavior: "smooth", block: "center" });
    } else if (target === "Soluções") {
      solutions.current?.scrollIntoView({ behavior: "smooth", block: "center" });
    } else if (target === "Institucional") {
      institutional.current?.scrollIntoView({ behavior: "smooth", block: "center" });
        ...
        <section className={styles.presentation}>
          <div>
            <div>
              ...
              <span>
                Transformamos complexidade fiscal em segurança jurídica, eficiência operacional e inteligência
          ...
          <div ref={institutional}>
            ...
            <div>
              ...
              <p>
                ...
                indústrias, serviços de alta complexidade e grupos econômicos. A filosofia é simples: profundidade
                técnica absoluta somada a uma relação próxima, humana e transparente com a diretoria.
              </p>
              <p>
